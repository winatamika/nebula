...
{{ Form::open(array('route' => 'priceplan.store','files'=>true)) }}
<div class="form-group">
   ...
   <!-- <div class="form-group">
        {{ Form::label('room id', 'room id:', array('class'=>'col-sm-2 control-label')) }}
          <div class="col-sm-10">
        {{ Form::text('room_id','',array('class'=>'form-control' , 'id'=> 'inputEmail3')) }}
    </div>
    </div>-->
     <div class="form-group">
        {{ Form::label('start date', 'start date:', array('class'=>'col-sm-2 control-label')) }}
          <div class="col-sm-10">
        {{ Form::text('start_date','',array('class'=>'form-control' , 'id'=> 'checkin')) }}
    </div>
    </div>
   <div class="form-group">
        {{ Form::label('end date', 'end date:', array('class'=>'col-sm-2 control-label')) }}
           <div class="col-sm-10">
        {{ Form::text('end_date','',array('class'=>'form-control' , 'id'=> 'checkout')) }}
    </div>
    </div>
  <div class="form-group">
      {{ Form::label('sun', 'sun', array('class'=>'col-sm-2 control-label'))}}
         <div class="col-sm-10">
      {{ Form::text('sun','',array('class'=>'form-control' , 'id'=> 'inputEmail3'))}}
  </div>
  </div>
    <div class="form-group">
      {{ Form::label('mon', 'mon', array('class'=>'col-sm-2 control-label'))}}
         <div class="col-sm-10">
      {{ Form::text('mon','',array('class'=>'form-control' , 'id'=> 'inputEmail3'))}}
  </div>
  </div>
   <div class="form-group">
      {{ Form::label('tue', 'tue', array('class'=>'col-sm-2 control-label'))}}
         <div class="col-sm-10">
      {{ Form::text('tue','',array('class'=>'form-control' , 'id'=> 'inputEmail3'))}}
  </div>
  </div>
   <div class="form-group">
      {{ Form::label('wed', 'wed', array('class'=>'col-sm-2 control-label'))}}
         <div class="col-sm-10">
      {{ Form::text('wed','',array('class'=>'form-control' , 'id'=> 'inputEmail3'))}}
        </div>
  </div>
   <div class="form-group">
      {{ Form::label('thu', 'thu', array('class'=>'col-sm-2 control-label'))}}
         <div class="col-sm-10">
      {{ Form::text('thu','',array('class'=>'form-control' , 'id'=> 'inputEmail3'))}}
        </div>
  </div>
   <div class="form-group">
      {{ Form::label('fri', 'fri', array('class'=>'col-sm-2 control-label'))}}
         <div class="col-sm-10">
      {{ Form::text('fri','',array('class'=>'form-control' , 'id'=> 'inputEmail3'))}}
        </div>
  </div>
   <div class="form-group">
      {{ Form::label('sat', 'sat', array('class'=>'col-sm-2 control-label'))}}
         <div class="col-sm-10">
      {{ Form::text('sat','',array('class'=>'form-control' , 'id'=> 'inputEmail3'))}}
        </div>
  </div>
