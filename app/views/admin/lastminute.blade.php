...
@section('content')
	...
	<div class="main-content">
		...
		<!-- FORM -->
		<h2>Create Last Minute</h2>
		<form action="{{ URL::route('lastminute-post') }}" class="form-horizontal has-success has-feedback" role="form" method="post">
		  ...
		  <div class="form-group">
		    <label for="inputEmail3" class="col-sm-2 control-label">Lastminute Days</label>
		    <div class="col-sm-10">
