...
@section('content')
	...
	<div class="main-content">
		...
		<form action="{{ URL::route('earlybird-update') }}" class="form-horizontal has-success has-feedback" role="form" method="post">
		  ...
		  <div class="form-group">
		    ...
		    <div class="col-sm-10">
		      <input type="text" name="start" class="form-control" id="start" value="{{ $early->checkin_start }}"  readonly="true"{{ (Input::old('start'))? ' value="' . Input::old('start') . '"' : '' }}>
		      @if($errors->has('start'))
					{{ $errors->first('start') }}
				@endif
		    </div>
		  ...
		  <div class="form-group">
		    ...
		    <div class="col-sm-10">
		      <input type="text" name="finish" class="form-control" id="finish" value="{{ $early->checkin_finish }}"  readonly="true"{{ (Input::old('finish'))? ' value="' . Input::old('finish') . '"' : '' }}>
		  ...
		  <div class="form-group">
		    ...
		    <div class="col-sm-10">
		      <input type="text" name="min" class="form-control" value="{{ $early->minimum_stay }}" id="inputEmail3"{{ (Input::old('email'))? ' value="' . Input::old('email') . '"' : '' }}>
		      @if($errors->has('min'))
					{{ $errors->first('min') }}
				@endif
		    </div>
		  ...
		  <div class="form-group">
		    ...
		    <div class="col-sm-10">
		      <input type="text" name="days" class="form-control" value="{{ $early->earlybird_days }}" id="inputEmail3">
		      @if($errors->has('days'))
					{{ $errors->first('days') }}
				@endif
		    </div>
		  ...
		  <div class="form-group">
		    ...
		    <div class="col-sm-9">
		      <input type="text" name="discount" class="form-control" value="{{ $early->discount }}" id="inputEmail3">
